# SAGPooling profiler evidence

- Representative case: `x=[1024,32]`, 16 graphs, 64 nodes per graph, ratio `0.5`, default `GraphConv`, device `npu:1`.
- Observed core types: `AI_CORE`, `AI_CPU`, `AI_VECTOR_CORE`, `MIX_AIV`.
- AICPU kernels:
